...
| Spring Security OAuth2 | 4.0.2 | OAuth2/OIDC authentication |
...
- **2.0.2**: Latest version with Spring Boot 4.0.2 compatibility
- **2.0.1**: Patch update with Spring Boot 4.0.1 compatibility
